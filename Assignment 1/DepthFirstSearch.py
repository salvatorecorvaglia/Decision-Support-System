...
class Solver:
    ...
    """
    def __init__(self, start):  # Start è un'istanza della classe Puzzle
        self.start = start
    ...
    def solve(self):
        ...
        seen = set()  # closed...contiene gli stati già visitati. IL metodo set() genera una lista senza ripetizioni
        seen.add(queue[0].state)
        while queue:
            # potevamo anche scrivere note = queue.popleft()
            # node = queue.pop()
            #  queue.pop() preleva un elemento da destra dalla lista queue (che viene riempita da sinistra verso destra)
...
class Puzzle:
    ...
    def __init__(self, board):
        self.width = len(board[0])  # len(board[0]) = 3 perchè restituisce la lunghezza del primo elemento della lista di liste 'board'
        self.board = board
